...
(function(){
  ...
  const WORD_POOLS = {
    ...
    yarros: [
      'VIOLET','XADEN','DAIN','RHIANNON','IMOGEN','RIDOC','LIAM','BRENNAN','MIRA','ANDARNA',
      'TAIRN','SGAEYL','GARRICK','SAWYER','FREYJA','JACK','SLOANE','BODHI','CIARAN','NOLAN',
      'JESINIA','LILITH','VARISH','QUINN','EMERY','BLAISE','THRESH','CAMILA','SOARLYN','TALON'
    ],
    maas: [
      'FEYRE','RHYSAND','TAMLIN','NESTA','ELAIN','AZRIEL','CASSIAN','AMREN','MORRIGAN','LUCIEN',
      'JURIAN','BRYCE','HUNT','DANIKA','AELIN','ROWAN','DORIAN','CHAOL','MANON','AEDION',
      'LYSANDRA','NEHEMIA','ELIDE','LORCAN','FENRYS','GAVRIEL','HELION','KALLIAS','THESAN','BERON'
    ],
    marvel: [
      'IRONMAN','SPIDERMAN','THOR','HULK','CAPTAIN','AMERICA','BLACKWIDOW','HAWKEYE','FALCON','WANDA',
      'VISION','LOKI','THANOS','GAMORA','DRAX','ROCKET','GROOT','STARLORD','NEBULA','ANTMAN',
      'WASP','PANTHER','SHURI','OKOYE','BUCKY','BRUCE','TONY','STEVE','NATASHA','CLINT'
    ]
  };
